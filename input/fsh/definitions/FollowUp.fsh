...
Usage: #definition
* insert Header
* name = "CraNE_CCCN_Pathway_Activity_Follow-Up_Definition"
* title = "Follow-Up"
...
* action[=].code[SCT] = $SCT#713058002 "End of life care planning (procedure)"
...
* action[=].code[SCT] = $SCT#713603004 "Advance care planning (procedure)"
* action[=].condition[+].kind = #start
...
* action[=].code[SCT] = $SCT#225304007 "Implementation of planned interventions (procedure)"
* action[=].code[SCT] = $SCT#710993005 "Monitoring response to treatment (regime/therapy)"
* action[=].code[SCT] = $SCT#225418004 "Surveillance of condition (regime/therapy)"
