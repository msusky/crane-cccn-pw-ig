...
Usage: #definition
* insert Header
* name = "CraNE_CCCN_Pathway_Activity_Patient_Consultation_Definition"
...
* action[=].action[=].code[SCT] = $SCT#225886003 "Medical assessment (procedure)"
* action[=].action[=].code[SCT] = $SCT#410551005 "Family history taking (procedure)"
* action[=].action[=].code[SCT] = $SCT#406551008 "Social assessment (procedure)"
* action[=].action[=].code[SCT] = $SCT#171209009 "Tobacco usage screening (procedure)"
...
// TODO: * action[=].action[=].code[SCT] = $SCT#5880005 "Physical examination procedure (procedure)"
// TODO: * action[=].action[=].code[SCT] = $SCT#81375008 "Physical assessment (procedure)"
* action[=].action[=].code[SCT] = $SCT#410182004 "Physical examination assessment (procedure)"
* action[=].action[=].code[SCT] = $SCT#445536008 "Assessment using assessment scale (procedure)"
...
// TODO: * action[=].action[=].code[SCT] = $SCT#273437007 "Eastern Cooperative Oncology Group scale for physical assessment (assessment scale)"
// TODO: * action[=].action[=].code[SCT] = $SCT#273546003 "Karnofsky performance status (assessment scale)"
// TODO: * action[=].action[=].code[SCT] = $SCT#762713009 "Charlson Comorbidity Index (assessment scale)"
// TODO: * action[=].action[=].code[SCT] = $SCT#446619003 "Adult comorbidity evaluation-27 (assessment scale)"
// TODO: * action[=].action[=].code[SCT] = $SCT#440233001 "Duke older Americans resources and services instrumental activities of daily living score (assessment scale)"
...
* action[=].action[=].code[SCT] = $SCT#15220000 "Laboratory test (procedure)"
// NOTE: https://www.ncbi.nlm.nih.gov/books/NBK507821/
* action[=].action[=].code[SCT] = $SCT#88308000 "Blood cell count (procedure)"
* action[=].action[=].code[SCT] = $SCT#269858003 "Biochemical evaluation of blood urea/renal function (procedure)"
* action[=].action[=].code[SCT] = $SCT#269856004 "Measurement of liver enzyme (procedure)"
// NOTE: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9186248/
* action[=].action[=].code[SCT] = $SCT#13861005 "Biopsy of bone (procedure)"
* action[=].action[=].code[SCT] = $SCT#11274001 "Lactate dehydrogenase measurement (procedure)"
* action[=].action[=].code[SCT] = $SCT#35785002 "Measurement of gamma-enolase (procedure)"
...
* action[=].action[=].code[SCT] = $SCT#310866003 "Informing patient (procedure)"
* action[=].action[=].code[SCT] = $SCT#225323000 "Smoking cessation education (procedure)"
// TODO: Consultation vs. Education * action[=].action[=].code[SCT] = $SCT#1290027009 "Consultation for smoking cessation (procedure)"
// TODO: * action[=].action[=].code[SCT] = $SCT#409073007 "Education (procedure)"