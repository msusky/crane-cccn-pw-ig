...
Usage: #definition
* insert Header
* name = "CraNE_CCCN_Pathway_Activity_Staging_Diagnostics_Definition"
...
* action[=].code[SCT] = $SCT#386053000 "Evaluation procedure (procedure)"
* action[=].code[SCT] = $SCT#165197003 "Diagnostic assessment (procedure)"
* action[=].code[SCT] = $SCT#396927009 "Molecular testing, diagnostic (procedure)"
* action[=].code[SCT] = $SCT#370851004 "Evaluation of diagnostic study results (procedure)"
...
* action[=].action[=].code[SCT] = $SCT#363679005 "Imaging (procedure)"
* action[=].action[=].code[SCT] = $SCT#413815006 "Chest imaging (procedure)"
* action[=].action[=].code[SCT] = $SCT#441875004 "Imaging of head (procedure)"
* action[=].action[=].code[SCT] = $SCT#363680008 "Radiographic imaging procedure (procedure)"
* action[=].action[=].code[SCT] = $SCT#450436003 "Positron emission tomography with computed tomography (procedure)"
* action[=].action[=].code[SCT] = $SCT#241601008 "Magnetic resonance imaging of head (procedure)"
...
* action[=].action[=].code[SCT] = $SCT#165197003 "Diagnostic assessment (procedure)"
...
* action[=].action[=].action[=].code[SCT] = $SCT#55198006 "Bronchoscopy with biopsy (procedure)"
...
* action[=].action[=].action[=].code[SCT] = $SCT#441561002 "Endobronchial ultrasound examination of mediastinum (procedure)"
* action[=].action[=].action[=].code[SCT] = $SCT#1137699004 "Endoscopic EBUS-TBNA (endobronchial ultrasound transbronchial needle aspiration) of mediastinal lymph node"
* action[=].action[=].action[=].code[SCT] = $SCT#450556004 "Endoscopic ultrasonography (procedure)"
* action[=].action[=].action[=].code[SCT] = $SCT#879954008 "EUS FNA (endoscopic ultrasonography fine needle aspiration) of mediastinal lymph node"
* action[=].action[=].action[=].code[SCT] = $SCT#261479009 "Mediastinoscopy (procedure)"
* action[=].action[=].action[=].code[SCT] = $SCT#238325002 "Mediastinoscopy and lymph node sampling (procedure)"
...
* action[=].action[=].action[=].code[SCT] = $SCT#277590007 "Imaging guided biopsy (procedure)"
* action[=].action[=].action[=].code[SCT] = $SCT#277591006 "Computed tomography guided biopsy (procedure)"
...
* action[=].action[=].code[SCT] = $SCT#168456004 "Gross pathology request (procedure)"
* action[=].action[=].code[SCT] = $SCT#275640004 "Refer to pathology laboratory (procedure)"
* action[=].action[=].code[SCT] = $SCT#708179009 "Molecular pathology service (qualifier value)"
* action[=].action[=].relatedAction.actionId = "diagnosis-assurance"
...
* action[=].action[=].code[SCT] = $SCT#254292007 "Tumor staging (tumor staging)"
* action[=].action[=].code[SCT] = $SCT#258234001 "Tumor-node-metastasis (TNM) tumor staging classifications (tumor staging)"
* action[=].action[=].relatedAction.actionId = "imaging"
* action[=].action[=].relatedAction.relationship = #after-end
* action[=].action[=].relatedAction.actionId = "pathology"
* action[=].action[=].relatedAction.relationship = #after-end
...
* action[=].code[SCT] = $SCT#58000006 "Patient discharge (procedure)"
* action[=].condition.kind = #start
